...
public enum Game {
    ...
    MIXED_ARCADE(16, "Arcade", new JSONObject().put("type", "game").put("game", "MIXED_ARCADE").put("rotation", new JSONArray().put("SPLEEF").put("RUNNER")).put("max_players", 16).put("min_players", 8), MemoryAllocation.GAME, Arrays.asList(Module.ENGINE, Module.GAME)),
