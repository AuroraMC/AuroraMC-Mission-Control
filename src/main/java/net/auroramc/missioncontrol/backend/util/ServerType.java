...
public enum ServerType {
    ...
    BACKSTAB(16, "PB", new JSONObject().put("type", "game").put("game", "BACKSTAB").put("rotation", new JSONArray().put("BACKSTAB")).put("max_players", 16).put("min_players", 8), MemoryAllocation.GAME, Arrays.asList(Module.ENGINE, Module.GAME)),
    PAINTBALL(16, "BKS", new JSONObject().put("type", "game").put("game", "PAINTBALL").put("rotation", new JSONArray().put("PAINTBALL")).put("max_players", 16).put("min_players", 8), MemoryAllocation.GAME, Arrays.asList(Module.ENGINE, Module.GAME)),
