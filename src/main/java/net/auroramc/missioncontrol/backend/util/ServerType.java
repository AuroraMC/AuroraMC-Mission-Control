...
public enum ServerType {
    ...
    ARCADE_MODE(16, "Arcade", new JSONObject().put("type", "game").put("game", "ARCADE_MODE").put("rotation", new JSONArray().put("SPLEEF").put("FFA").put("HOT_POTATO").put("TAG").put("RUN")).put("max_players", 16).put("min_players", 4), MemoryAllocation.GAME, Arrays.asList(Module.ENGINE, Module.GAME)),
    ...
    SMP_OVERWORLD(50, "SMP", new JSONObject().put("type", "smp").put("game", "SMP").put("smp_type", "OVERWORLD").put("rotation", new JSONArray()).put("max_players", 50), MemoryAllocation.SMP, Collections.emptyList()),
    SMP_NETHER(50, "SMP", new JSONObject().put("type", "smp").put("game", "SMP").put("smp_type", "NETHER").put("rotation", new JSONArray()).put("max_players", 50), MemoryAllocation.SMP, Collections.emptyList()),
    SMP_END(50, "SMP", new JSONObject().put("type", "smp").put("game", "SMP").put("smp_type", "END").put("rotation", new JSONArray()).put("max_players", 50), MemoryAllocation.SMP, Collections.emptyList()),
