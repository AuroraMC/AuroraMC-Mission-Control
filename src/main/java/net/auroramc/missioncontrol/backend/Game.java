...
public enum Game {
    ...
    CRYSTAL_QUEST(10, "Crystal", new JSONObject().put("type", "game").put("game", "CRYSTAL_QUEST").put("rotation", new JSONArray().put("CRYSTAL_QUEST")), MemoryAllocation.GAME, Arrays.asList(Module.ENGINE, Module.GAME)),
